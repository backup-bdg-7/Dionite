// ============================================================================
// Dionite — iOS DioniteBridge: Swift ↔ C++ glue (3D ARPG core).
// Adds click-to-move + camera-pan extern-Cs alongside the input forwarding.
// ============================================================================
import Foundation
...
@_silgen_name("dionite_click_to_move")  func dionite_click_to_move(_ x: Float, _ y: Float, _ z: Float)
...
@_silgen_name("dionite_camera_pan")     func dionite_camera_pan(_ dx: Float)
...
final class DioniteBridge {
    ...
    func panCamera(deltaDeg: Float)                  { dionite_camera_pan(deltaDeg) }
