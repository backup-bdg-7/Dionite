    ...
    <div className="app-shell vignette" style={{ overflow: 'auto' }}>
      ...
      <header style={{ padding: '40px 48px 12px', borderBottom: '1px solid #3a3632', position: 'relative' }}>
        ...
        <p style={{ maxWidth: 720, marginTop: 18, color: '#a39e96', fontSize: 15, lineHeight: 1.6 }}>
          An open-world ARPG with <strong>Diablo III/IV-style isometric 3D combat</strong> — 5 classes (Crusader, Necromancer,
          Sorcerer, Ranger, Monk), ~25 unique skills per class with proper resource + cooldown rules, infinite Paragon
          board, multi-character roster, click-to-move + WASD hybrid input, PBR rendering, cascaded shadow maps, and dynamic
          point lights. This repository ships the complete source scaffolding — C++ shared core, Swift + Metal iOS layer,
